...
\begin{enumerate}
    ...
    \begin{center}
    \includegraphics[width=6in]{question3/county-box-p1.png}
    \includegraphics[width=6in]{question3/county-box-p2.png}
    \end{center}
    ...
    \begin{center}
    \includegraphics[width=6in]{question6/line-p1.png}
    \includegraphics[width=6in]{question6/line-p2.png}
    \end{center}

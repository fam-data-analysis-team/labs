...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[height=2.8in]{plots/lab4/kernal/npreg_comparison_final.png}
  \end{center}
...
\begin{frame}
  ...
  \resizebox{\textwidth}{!}{ 
    \begin{tabular}{llrrrrr}
      \toprule
    Метод & Тип & Bandwidth & R\_squared & RMSE\_train & RMSE\_test & MAE\_test \\
      \midrule
    Надарая-Вотсона & Константна (LC) & 1.83 & 0.41 & 24.52 & 24.57 & 19.08 \\
      Локально лінійна & Лінійна (LL) & 1.94 & 0.41 & 24.53 & 24.58 & 19.08 \\
      \bottomrule
    \end{tabular}
  }
\end{frame}
...
\begin{frame}
  ...
  \toprule
  & lin & np (1) & nppl (2.1) & nppl (2.2) \\ \midrule %% TinyTableHeader
  reform\_days & \num{-0.010081}*** &  & \num{-0.009989}*** & \num{-0.010092}*** \\
  & (\num{0.000770}) &  & (\num{0.000342}) & (\num{0.000342}) \\
  jul\_days & \num{0.755704}*** &  &  &  \\
  & (\num{0.022698}) &  &  &  \\

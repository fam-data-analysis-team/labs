...
save_data_as_csv_and_latex(format(ci_variance_df), "ci_variance.csv", "ci_variance.txt")
```
...
save_data_as_csv_and_latex(format(daytime_diff,nsmall=3), "df_daytime_summary.csv", "df_daytime_summary.txt")
...
save_data_as_csv_and_latex(format(seasonal_diff,nsmall=3), "df_seasonal_summary.csv", "df_seasonal_summary.txt")
...
save_data_as_csv_and_latex(format(summary_stats, nsmall = 3), "summary_stats.csv", "summary_stats.txt")

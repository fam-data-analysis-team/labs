...
x_grob <- textGrob("Швидкість вітру (м/с)", gp = gpar(fontsize = 20))
y_grob <- textGrob("Концентрація частинок", gp = gpar(fontsize = 20), rot=90)
...
ggsave(
  here("plots", "question1", "wind_speed_vs_pm.png"), 
  windspeed_vs_pm, 
  bg = "white",
  dpi = 200)
```

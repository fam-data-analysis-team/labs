...
wind_speed_vs_pm <- ggplot(dt, aes(x = windspeed)) +
  ...
  labs(title = "Вплив швидкості вітру\nна концентрацію частинок PM2.5 і PM10",
       x = "Швидкість вітру (windspeed)",
       y = "Концентрація частинок",
       color = "Тип частинок")

ggsave(here("plots", "question1", "wind_speed_vs_pm.png"), wind_speed_vs_pm, dpi = 200)
```
...
```{r}
aqi_pm_polutants <- ggplot(dt, aes(x = pm2.5, y = aqi, size = co)) +

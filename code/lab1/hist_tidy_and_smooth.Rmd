...
dir.create("../../plots/hist_tidy_and_smooth/", recursive = TRUE, showWarnings = FALSE)
```
...
ggsave("../../plots/hist_tidy_and_smooth/hist1.png", p)
...
ggsave("../../plots/hist_tidy_and_smooth/hist2.png", p)
```
...
ggsave("../../plots/hist_tidy_and_smooth/hist3.png", p)
...
ggsave("../../plots/hist_tidy_and_smooth/hist4.png", p)
```
...
ggsave("../../plots/hist_tidy_and_smooth/hist-log.png", p)
...
ggsave("../../plots/hist_tidy_and_smooth/hist-log-smooth.png", p)
```
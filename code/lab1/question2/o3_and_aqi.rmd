...
ggsave(here("plots", "question2", "boxplot_pollutants.png"), boxplot_pollutants)
```
...
ggsave(here("plots", "question2", "o3_plot.png"), o3_plot)
```
...
ggsave(here("plots", "question2", "so2_plot.png"), so2_plot)
```
...
ggsave(here("plots", "question2", "scatter_plot.png"), scatter_plot)
...
ggsave(here("plots", "question2", "seasonal_plot.png"), seasonal_plot)
```
